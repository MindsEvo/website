...
window.ROOTGENE_REGISTRY = {
  ...
  "genes": {
    ...
    "RG.LANGUAGE.OBSERVATION.DESCRIBE": {
      "category": "LANGUAGE",
      "zh": "观察发现",
      "en": "Observe & Notice",
      "short": {
      ...
      "descZh": "在一段具体的文本或画面里发现细节，并判断哪个细节对理解最重要、暗示了什么。",
      "descEn": "Notice details in a specific text or picture, and judge which detail matters most for understanding and what it suggests.",
      "boundaryZh": "与 RG.SCIENCE.OBSERVATION.BASIC 的界限：科学观察记录真实现象，为因果推理服务；本基因的细节只存在于这一段素材里，不读素材答不出来。",
      "boundaryEn": "Boundary with RG.SCIENCE.OBSERVATION.BASIC: science observation records real phenomena to support causal reasoning; here the details exist only in this passage, so the question cannot be answered without reading it."
    },
    "RG.LANGUAGE.COMPREHENSION.INFO": {
      "category": "LANGUAGE",
      "zh": "信息理解",
      "en": "Understand Information",
      "short": {
        "zh": "理解",
        "en": "Understand"
      },
      "descZh": "理解文本明确说了什么，并区分主要内容和次要细节。",
      "descEn": "Understand what a text states, and tell the main point apart from minor details.",
      "boundaryZh": "与 RG.LANGUAGE.INFERENCE.EVIDENCE 的界限：信息理解的答案在原文里可以直接找到或直接概括出来；推理的答案原文没有直说。",
      "boundaryEn": "Boundary with RG.LANGUAGE.INFERENCE.EVIDENCE: in comprehension the answer is stated or can be summarised directly from the text; in inference the text never says it outright."
    },
    "RG.LANGUAGE.INFERENCE.EVIDENCE": {
      "category": "LANGUAGE",
      "zh": "推理与证据",
      "en": "Infer from Evidence",
      "short": {
        "zh": "推理",
        "en": "Infer"
      },
      "descZh": "从文本线索推出没有直接说出的信息（心情、原因、接下来会发生什么），并能回到原文指出依据。",
      "descEn": "Work out what the text does not state (feelings, causes, what happens next) from its clues, and point back to the evidence in the text.",
      "boundaryZh": "与 RG.LOGIC.REASONING.BASIC 的界限：逻辑推理的前提是抽象给定的规则；本基因的前提是叙事语言本身（动作、神态、用词），并且必须回到文本找证据。",
      "boundaryEn": "Boundary with RG.LOGIC.REASONING.BASIC: logic reasoning starts from abstract given rules; this gene starts from narrative language itself (actions, expressions, wording) and must point back to evidence in the text."
    },
    "RG.LANGUAGE.STRUCTURE.SEQUENCE": {
      "category": "LANGUAGE",
      "zh": "顺序与结构",
      "en": "Sequence & Structure",
      "short": {
        "zh": "结构",
        "en": "Structure"
      },
      "descZh": "依据文本里的顺序信号（时间词、因果连接）重建事件的先后，认识开头、经过、结尾，并区分“写的顺序”和“发生的顺序”。",
      "descEn": "Rebuild the order of events from the text's own signals (time words, cause-and-effect links), recognise beginning, middle and end, and tell the order of telling apart from the order of events.",
      "boundaryZh": "与 RG.PATTERN.SEQUENCE.BASIC 的界限：规律序列延续一条可见的规则；本基因的顺序只能从这篇文本的语言信号里得出，不能只靠生活常识。",
      "boundaryEn": "Boundary with RG.PATTERN.SEQUENCE.BASIC: a pattern sequence extends a visible rule; here the order can only come from this text's language signals, not from general common sense."
    },
    "RG.LANGUAGE.CHOICE.CONTEXT": {
      "category": "LANGUAGE",
      "zh": "语言选择",
      "en": "Word Choice in Context",
      "short": {
        "zh": "用词",
        "en": "Word Choice"
      },
      "descZh": "比较不同的词语或说法放在具体语境里的效果，判断哪个更准确、更生动、更适合场合，并说出理由。",
      "descEn": "Compare how different words or phrasings work in a specific context, judge which is more precise, vivid or appropriate, and say why.",
      "boundaryZh": "与 RG.LANGUAGE.SEMANTIC.RELATION 的界限：词义关系判断词与词之间的关系；本基因判断词与语境是否相配。",
      "boundaryEn": "Boundary with RG.LANGUAGE.SEMANTIC.RELATION: semantic relation judges how two words relate to each other; this gene judges how well a word fits its context."
    },
    "RG.LANGUAGE.EXPRESSION.GUIDED": {
      "category": "LANGUAGE",
      "zh": "引导表达",
      "en": "Guided Expression",
      "short": {
        "zh": "表达",
        "en": "Express"
      },
      "descZh": "在读过的故事基础上，用给定的表达要素组织自己的想法（续编、换角色想），再对照他人的不同角度进行反思，没有唯一正确答案。",
      "descEn": "Building on a story just read, organise one's own idea from given building blocks (continue it, or think as another character), then reflect on it against others' different viewpoints; there is no single right answer.",
      "boundaryZh": "与 RG.LANGUAGE.SEMANTIC.RELATION 的界限：词义关系有对错判定；本基因不判对错，训练的是组织表达并从他人视角反思。",
      "boundaryEn": "Boundary with RG.LANGUAGE.SEMANTIC.RELATION: semantic relation is judged right or wrong; this gene is never judged, and trains organising an idea and reflecting from others' viewpoints.",
      "status": "active"
    },
    "RG.SCIENCE.OBSERVATION.BASIC": {
      ...
      "descZh": "有系统地记录一个现象的特征与细节，为后续推理提供依据，而不只是「看一看」。",
      "descEn": "Systematically record the features and details of a phenomenon to support later reasoning, rather than merely looking.",
      "boundaryZh": "与 RG.ATTENTION.SEARCH.VISUAL 的界限：视觉搜索训练的是在干扰项中找到并确认一个目标；本基因训练的是记录一个现象本身有哪些特征细节以供推理，不是「找目标」。",
      "boundaryEn": "Boundary with RG.ATTENTION.SEARCH.VISUAL: visual search trains finding and confirming a target among distractors; this gene trains recording the features and details of a phenomenon itself for later reasoning, not locating a target."
    },
    "RG.SCIENCE.QUESTIONING.BASIC": {
      ...
      "descZh": "从观察到的现象中提出一个可以被检验的问题：找出尚不清楚的地方，并把它表述成可以去调查的形式。",
      "descEn": "Form a testable question from an observed phenomenon: identify what is not yet known and frame it as something that can be investigated.",
      "boundaryZh": "与 RG.SCIENCE.OBSERVATION.BASIC 的界限：观察记录的是现象「是什么」，本基因训练的是找出现象里「还不知道什么」，并把它转成一个可检验的问题，二者方向相反、缺一不可。",
      "boundaryEn": "Boundary with RG.SCIENCE.OBSERVATION.BASIC: observation records what a phenomenon IS, while this gene trains identifying what is NOT yet known about it and turning that gap into a testable question — the two point in opposite but complementary directions."
    },
    "RG.SCIENCE.PREDICTION.BASIC": {
      ...
      "descZh": "在实验或行动发生之前，依据一个假设说出预期会发生的结果，以便日后与实际结果对照检验。",
      "descEn": "State an expected outcome before an experiment or action takes place, based on a hypothesis, so it can later be checked against the actual result.",
      "boundaryZh": "与 RG.PATTERN.SEQUENCE.BASIC 的界限：序列规律训练的是延续一条已经看得见的重复或递进规则；本基因训练的是在行动或实验发生之前，依据因果假设说出预期结果，续写的对象是不可见的未来结果，不是一条已展示的序列。",
      "boundaryEn": "Boundary with RG.PATTERN.SEQUENCE.BASIC: pattern sequence trains continuing an already-visible repeating or progressing rule; this gene trains stating an expected outcome of an action or experiment before it happens, based on a hypothesis about cause and effect — not extending a rule that is already on display."
    },
    "RG.SCIENCE.EXPERIMENTATION.BASIC": {
      ...
      "descZh": "设计一个公平的检验：决定要改变哪一个变量、保持哪些条件不变，以此来检验一个假设。",
      "descEn": "Design a fair test by deciding which variable to change and which conditions to keep the same, in order to check a hypothesis.",
      "boundaryZh": "与 RG.STRATEGY.DECISION.PLANNING 的界限：决策规划训练的是在多个可行方案中权衡取舍并安排先后步骤以达成目标；本基因训练的是为了检验一个因果假设而专门分离并控制变量，这里的目标特指因果检验，不是一般性的方案规划。",
      "boundaryEn": "Boundary with RG.STRATEGY.DECISION.PLANNING: decision planning trains weighing options and ordering steps to reach a goal; this gene trains isolating and controlling variables specifically to test a hypothesis — the goal here is causal testing, not general planning."
    },
    "RG.SCIENCE.EVIDENCE.BASIC": {
      ...
      "descZh": "判断观察到的数据是否足够、是否相关，能否支持或推翻一个结论。",
      "descEn": "Judge whether observed data is sufficient and relevant enough to support or refute a conclusion.",
      "boundaryZh": "与 RG.LOGIC.COMPARISON.BASIC 的界限：比较判断的是两个已知对象或数量之间的关系；本基因判断的是一整批数据是否足够有力去支持某个给定的结论，是对「支持力度是否充分」的判断，不是对数值关系的判断。",
      "boundaryEn": "Boundary with RG.LOGIC.COMPARISON.BASIC: comparison judges the relation between two known objects or quantities; this gene judges whether a body of data is strong or sufficient enough to support a given conclusion — a different kind of judgment about sufficiency of support, not about the relation between values."
    },
    "RG.SCIENCE.EXPLANATION.BASIC": {
      ...
      "descZh": "构建一条把证据与结论连接起来的因果说明（为什么会发生），并在出现新证据时可以修正。",
      "descEn": "Construct a causal account that connects evidence to a conclusion (why something happened), revisable when new evidence appears.",
      "boundaryZh": "与 RG.LANGUAGE.SEMANTIC.RELATION 的界限：语言/词义基因关心的是词义本身的机制与词与词之间的关系；本基因关心的是连接证据与结论的因果链条是否成立，语言只是承载因果说明的载体，不是被训练的对象。",
      "boundaryEn": "Boundary with RG.LANGUAGE.SEMANTIC.RELATION: language/semantic genes are about the mechanics of word meaning and relations between words; this gene is about whether the causal chain linking evidence to a conclusion actually holds together — language is only the carrier of the explanation, not what is being trained."
    }
  }
};
